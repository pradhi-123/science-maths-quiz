...
const DEFAULT_QUESTIONS = [
  ...
  {
    id: "r1-q1",
    bg: "url('/images/ppt2022/image25.jpeg') no-repeat center center / cover",
    round: 1,
  ...
  {
    id: "r1-q2",
    bg: "url('/images/ppt2022/image26.jpeg') no-repeat center center / cover",
    round: 1,
  ...
  {
    id: "r1-q3",
    bg: "url('/images/ppt2022/image27.jpeg') no-repeat center center / cover",
    round: 1,
  ...
  {
    id: "r1-q4",
    bg: "url('/images/ppt2022/image28.jpeg') no-repeat center center / cover",
    round: 1,
  ...
  {
    id: "r1-q5",
    bg: "url('/images/ppt2022/image29.jpeg') no-repeat center center / cover",
    round: 1,
  ...
  {
    id: "r1-q6",
    bg: "url('/images/ppt2022/image31.jpeg') no-repeat center center / cover",
    round: 1,
  ...
  {
    id: "r2-q1",
    bg: "url('/images/ppt2022/image34.jpeg') no-repeat center center / cover",
    round: 3,
  ...
  {
    id: "r2-q2",
    bg: "url('/images/ppt2022/image35.jpeg') no-repeat center center / cover",
    round: 3,
  ...
  {
    id: "r2-q3",
    bg: "url('/images/ppt2022/image37.jpeg') no-repeat center center / cover",
    round: 3,
  ...
  {
    id: "r2-q4",
    bg: "url('/images/ppt2022/image41.jpeg') no-repeat center center / cover",
    round: 3,
  ...
  {
    id: "r2-q5",
    bg: "url('/images/ppt2022/image42.jpeg') no-repeat center center / cover",
    round: 3,
  ...
  {
    id: "r2-q6",
    bg: "url('/images/ppt2022/image45.jpeg') no-repeat center center / cover",
    round: 3,
  ...
  {
    id: "r3-q1",
    bg: "url('/images/ppt2022/image46.jpeg') no-repeat center center / cover",
    round: 4,
  ...
  {
    id: "r3-q2",
    bg: "url('/images/ppt2022/image47.jpeg') no-repeat center center / cover",
    round: 4,
  ...
  {
    id: "r3-q3",
    bg: "url('/images/ppt2022/image48.jpeg') no-repeat center center / cover",
    round: 4,
  ...
  {
    id: "r3-q4",
    bg: "url('/images/ppt2022/image50.jpeg') no-repeat center center / cover",
    round: 4,
  ...
  {
    id: "r3-q5",
    bg: "url('/images/ppt2022/image51.jpeg') no-repeat center center / cover",
    round: 4,
  ...
  {
    id: "r3-q6",
    bg: "url('/images/ppt2022/image52.jpeg') no-repeat center center / cover",
    round: 4,
  ...
  {
    id: "r4-q1",
    bg: "url('/images/ppt2022/image53.jpeg') no-repeat center center / cover",
    round: 2,
  ...
  {
    id: "r4-q2",
    bg: "url('/images/ppt2022/image55.jpeg') no-repeat center center / cover",
    round: 2,
  ...
  {
    id: "r4-q3",
    bg: "url('/images/ppt2022/image56.jpeg') no-repeat center center / cover",
    round: 2,
  ...
  {
    id: "r4-q4",
    bg: "url('/images/ppt2022/image57.jpeg') no-repeat center center / cover",
    round: 2,
  ...
  {
    id: "r4-q5",
    bg: "url('/images/ppt2022/image59.jpeg') no-repeat center center / cover",
    round: 2,
  ...
  {
    id: "r4-q6",
    bg: "url('/images/ppt2022/image60.jpeg') no-repeat center center / cover",
    round: 2,
  ...
  {
    id: "r5-q1",
    bg: "url('/images/ppt2022/image61.jpeg') no-repeat center center / cover",
    round: 5,
  ...
  {
    id: "r5-q2",
    bg: "url('/images/ppt2022/image63.jpeg') no-repeat center center / cover",
    round: 5,
  ...
  {
    id: "r5-q3",
    bg: "url('/images/ppt2022/image65.jpeg') no-repeat center center / cover",
    round: 5,
  ...
  {
    id: "r5-q4",
    bg: "url('/images/ppt2022/image68.jpeg') no-repeat center center / cover",
    round: 5,
...
export function getSavedQuestions() {
  const data = localStorage.getItem('school_quiz_questions_v11');
  let savedList = [];
  if (data) {
    try {
  ...
  if (Array.isArray(savedList) && savedList.length > 0) {
    ...
    localStorage.setItem('school_quiz_questions_v11', JSON.stringify(merged));
    return merged;
  }

  // Initialize with seed
  localStorage.setItem('school_quiz_questions_v11', JSON.stringify(DEFAULT_QUESTIONS));
  return DEFAULT_QUESTIONS;
}

export function saveQuestions(list) {
  localStorage.setItem('school_quiz_questions_v11', JSON.stringify(list));
}
